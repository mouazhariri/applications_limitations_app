        ...
        data: (data) => ListView(
          ...
          children: [
            ...
            Wrap(
              ...
              children: _presets.map((duration) => LimitChoiceChip(
                    ...
                    onSelected: () async {
                      ...
                      await ref.read(provider.notifier).setLimit(duration);
                    },
                  )).toList(),
            ),
            const SizedBox(height: 24),
            TextField(
              ...
              onChanged: ref.read(provider.notifier).updateCustomMinutes,
            ),
            const SizedBox(height: 12),
            FilledButton(
              onPressed: data.isSaving
                  ...
                  : () async {
                      if (!await ParentUnlockDialog.show(context)) return;
                      await ref.read(provider.notifier).setCustomLimit();
                    },
            ...
            OutlinedButton(
              onPressed: data.currentLimit == null || data.isSaving
                  ...
                  : () async {
                      if (!await ParentUnlockDialog.show(context)) return;
                      await ref.read(provider.notifier).removeLimit();
                    },
