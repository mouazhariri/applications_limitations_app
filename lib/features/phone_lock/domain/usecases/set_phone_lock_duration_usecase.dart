...
class SetPhoneLockDurationUseCase {
  const SetPhoneLockDurationUseCase(this._repository);
  final PhoneLimitRepository _repository;
  Future<Either<Failure, Success>> call(Duration lockDuration) =>
      _repository.setLockDuration(lockDuration);
}
