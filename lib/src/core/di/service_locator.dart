...
import 'package:applications_limitations/features/app_lock/data/datasource/app_limit_local_datasource.dart';
import 'package:applications_limitations/features/app_lock/data/repository/app_limit_repository_impl.dart';
import 'package:applications_limitations/features/app_lock/domain/repositories/app_limit_repository.dart';
import 'package:applications_limitations/features/app_lock/domain/usecases/get_app_limit_usecase.dart';
import 'package:applications_limitations/features/app_lock/domain/usecases/remove_app_limit_usecase.dart';
import 'package:applications_limitations/features/app_lock/domain/usecases/set_app_limit_usecase.dart';
import 'package:applications_limitations/features/app_usage/data/datasource/app_usage_platform_datasource.dart';
import 'package:applications_limitations/features/app_usage/data/repository/app_usage_repository_impl.dart';
import 'package:applications_limitations/features/app_usage/domain/repositories/app_usage_repository.dart';
import 'package:applications_limitations/features/app_usage/domain/usecases/get_installed_apps_usecase.dart';
import 'package:applications_limitations/features/app_usage/domain/usecases/get_usage_stats_usecase.dart';
...
import 'package:applications_limitations/features/dashboard/data/datasource/dashboard_local_datasource.dart';
import 'package:applications_limitations/features/dashboard/data/repository/dashboard_repository_impl.dart';
import 'package:applications_limitations/features/dashboard/domain/repositories/dashboard_repository.dart';
import 'package:applications_limitations/features/dashboard/domain/usecases/get_dashboard_snapshot_usecase.dart';
import 'package:applications_limitations/features/onboarding/data/datasource/onboarding_local_datasource.dart';
import 'package:applications_limitations/features/onboarding/data/repository/onboarding_repository_impl.dart';
import 'package:applications_limitations/features/onboarding/domain/repositories/onboarding_repository.dart';
import 'package:applications_limitations/features/onboarding/domain/usecases/complete_onboarding_usecase.dart';
import 'package:applications_limitations/features/onboarding/domain/usecases/get_onboarding_status_usecase.dart';
import 'package:applications_limitations/features/permissions/data/datasource/permissions_platform_datasource.dart';
import 'package:applications_limitations/features/permissions/data/repository/permissions_repository_impl.dart';
import 'package:applications_limitations/features/permissions/domain/repositories/permissions_repository.dart';
import 'package:applications_limitations/features/permissions/domain/usecases/get_permission_statuses_usecase.dart';
import 'package:applications_limitations/features/permissions/domain/usecases/open_permission_settings_usecase.dart';
import 'package:applications_limitations/features/phone_lock/data/datasource/phone_limit_local_datasource.dart';
import 'package:applications_limitations/features/phone_lock/data/repository/phone_limit_repository_impl.dart';
...
import 'package:applications_limitations/features/settings/domain/usecases/get_settings_usecase.dart';
import 'package:applications_limitations/features/settings/domain/usecases/update_settings_usecases.dart';
